...
- Bill analysis uses the user's own Anthropic key (secret `ANTHROPIC_API_KEY_2`), not Replit AI Integrations. **Why:** phone verification blocked enabling AI Integrations for this account.
