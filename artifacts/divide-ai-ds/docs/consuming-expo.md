# Consuming Divide Aí Design System in Expo apps

Read `artifacts/divide-ai-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/divide-ai-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/divide-ai-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/divide-ai-ds/lib/native-theme";
import { useColors } from "@workspace/divide-ai-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/divide-ai-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/divide-ai-ds/components/native/badge";
import { Button } from "@workspace/divide-ai-ds/components/native/button";
import { Card } from "@workspace/divide-ai-ds/components/native/card";
```
...
Import and render
`@workspace/divide-ai-ds/components/native/button`, then run Expo
