# Divide Aí Design System design system
...
workspace package (`@workspace/divide-ai-ds`): other artifacts depend
...
`@workspace/divide-ai-ds/components/...`. Never use a `@/` alias inside
...
for `@workspace/divide-ai-ds` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/divide-ai-ds` as a `workspace:*` dependency,
run `pnpm install`, and import directly from this package.

Read only the guides required by the current task:

- Building or styling web UI: `artifacts/divide-ai-ds/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/divide-ai-ds/docs/consuming-expo.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/divide-ai-ds/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/divide-ai-ds/docs/migrating-expo.md`
