# Consuming Divide Aí Design System in web apps

Read `artifacts/divide-ai-ds/docs/AGENTS.md` first. This guide covers
...
`artifacts/divide-ai-ds/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/divide-ai-ds/styles.css";
```
...
`node_modules/@workspace/divide-ai-ds/src/components` to `content`.
...
import {
  toast,
  useToast,
} from "@workspace/divide-ai-ds/hooks/use-toast";
```
...
`@workspace/divide-ai-ds/components/ui/button`. Run the app's typecheck
