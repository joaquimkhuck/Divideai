# Migrating web UI to Divide Aí Design System

Read `artifacts/divide-ai-ds/docs/AGENTS.md` and
`artifacts/divide-ai-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/divide-ai-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/divide-ai-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/divide-ai-ds/hooks/use-toast`
