# Migrating Expo UI to Divide Aí Design System

Read `artifacts/divide-ai-ds/docs/AGENTS.md` and
`artifacts/divide-ai-ds/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/divide-ai-ds/lib/native-theme` and
  `@workspace/divide-ai-ds/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/divide-ai-ds/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/divide-ai-ds` and retains only
